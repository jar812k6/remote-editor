...
class FtpRemoteEdit {
  ...
  activate() {
    ...
    self.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'remote-editor:unfocus': () => self.treeView.unfocus(),
  ...
  getCurrentServerConfig() {
    ...
    return (reasonForRequest) => {
      return new Promise((resolve, reject) => {
        ...
        let caution = 'Decline this message if you did not initiate a request to share your server configuration with a package!'
