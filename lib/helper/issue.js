...
// https://github.com/h3imdall/remote-editor/issues/44
export const throwErrorIssue44 = (e, password) => {
  ...
  console.info('https://github.com/h3imdall/remote-editor/issues/44');
  ...
  atom.notifications.addError(e.message, {
    ...
    buttons: [{
      text: 'View Issue',
      onDidClick: () => {
        shell.openExternal('https://github.com/h3imdall/remote-editor/issues/44');
      }
    }],
    description: 'The error was thrown from the remote-editor package. The error has already been reported in issue on github and a solution is being worked on. You can help by adding information to this issue. Please explain what actions triggered this error.',
  });
}
